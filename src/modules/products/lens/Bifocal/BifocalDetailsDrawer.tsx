...
interface BifocalDetailsDrawerProps {
  open: boolean;
...
function BifocalDetailsDrawer({
  ...
  const {
    ...
    queryKey: ["products", "bifocal", "view", productId],
    queryFn: () => getBifocalByProductId(productId as number),
    enabled: open && Boolean(productId),
  });

  const product = productDetails as BifocalDetailResponse | undefined;
            ...
            <div className="space-y-6">
              ...
              <section className="space-y-3">
                <div className="space-y-1">
                  ...
                  <p className="text-sm leading-6 text-muted-foreground">
                    Core bifocal product information.
                  </p>
                </div>
              ...
              <section className="space-y-3">
                <div className="space-y-1">
                  ...
                  <p className="text-sm leading-6 text-muted-foreground">
                    Final power values for this bifocal item.
                  </p>
                </div>
                <div className="grid gap-3 sm:grid-cols-3">
              ...
              <section className="space-y-3">
                <div className="space-y-1">
                  ...
                  <p className="text-sm leading-6 text-muted-foreground">
                    Supplier records attached to this bifocal product.
                  </p>
                </div>
...
export default BifocalDetailsDrawer;
