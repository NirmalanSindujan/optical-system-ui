...
function BifocalProductList() {
  ...
  const {
    ...
    queryKey: ["products", PRODUCT_VARIANT_TYPES.LENS, LENS_SUB_TYPES.BIFOCAL, search, page, PAGE_SIZE],
    queryFn: () => getLensesBySubType(LENS_SUB_TYPES.BIFOCAL, { page, size: PAGE_SIZE, q: search || undefined }),
      ...
      <CardHeader className="border-b pb-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Manage bifocal lens products.</p>
          </div>
